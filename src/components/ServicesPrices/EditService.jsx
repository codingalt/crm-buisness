...
const EditService = () => {
  ...
  useMemo(() => {
    if (isSuccess) {
      toastSuccess(t("serviceUpdatedSuccessfully"));
    }
  }, [isSuccess]);
  ...
  return (
    <div className={`${css.addService} max-w-screen-lg`}>
                ...
                <div className={css.inputContainer}>
                  ...
                  <div className={css.input}>
                    <Input
                      ...
                      value={values.time || ""}
                      variant="underlined"
                      placeholder={t("Enter service time in minutes Eg: 30")}
                      dir={direction}
                      startContent={
                        ...
                        <div className={css.right}>
                          ...
                          >
                            ...
                            <p>
                              ...
                              <span>SVG, PNG, JPG (recommended. 300x2500px)</span>
                              <ErrorMessage
                                name="image"
                                component="div"
                                className={css.errorSpan}
      ...
      {/* Loader  */}
      {!isInitialized && (
        <div className="w-full pt-44 flex items-center justify-center">
